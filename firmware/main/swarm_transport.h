...
/**
 * Start a low-level ping/ack task for verifying radio connectivity.
 * Useful during initial hardware bring-up or range testing.
 *
 * @param role      0 = responder (echoes pings), 1 = initiator (sends pings)
 * @param peer_mac  Target peer MAC address (used by initiator only)
 */
