...
// ------------------------------------------
// AQUABOT_SIGNALING_URL is injected by Flask via the index.html template.
// Set AQUABOT_SIGNALING_CLIENT_HOST env var on the Jetson before launch
// so the browser connects to the correct IP (e.g. ws://192.168.1.187:8765).
const signalingUrl = window.AQUABOT_SIGNALING_URL || "ws://localhost:8765";
window.ws = new WebSocket(signalingUrl);
